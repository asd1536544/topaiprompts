        ...
        <main className="mx-auto max-w-6xl px-4 pb-16 pt-12 lg:px-8 lg:pt-16">
          <section className="grid gap-10 lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
                AI Prompt Generator Hub for Creators, Not Just “AI Users”
              </h1>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                ...
                >
                  Start with Script Prompts
                </Link>
                <p className="text-xs text-gray-500">
                  No login. Free to use. Built for long-term creator workflows.
                </p>
              </div>
          ...
          <section className="mt-16 grid gap-12 lg:grid-cols-[1.1fr,0.9fr]">
            <article className="prose prose-sm max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-indigo-600 prose-strong:text-gray-900">
              <h2>Why Build a Creator-Focused AI Tool Hub Instead of a Generic Tool Site</h2>
              <p>
                Most “AI tool collections” on the internet are built for
                everyone and therefore work for almost no one. They list dozens
                of tools in every category and leave you to figure out which
                ones fit your workflow. This hub takes a different approach: it
                focuses on one ecosystem, YouTube, and on one type of user,
                creators.
              </p>
              <p>
                By narrowing the scope to YouTube script prompts, hooks, titles,
                and descriptions, each tool can be opinionated. The UX, the
                copy, and even the example prompts are written with real creator
                problems in mind: publishing consistently, improving retention,
                and turning views into a business.
              </p>
              <p>
                You do not need another dashboard to manage. You need a small
                set of reliable building blocks you can reach for every time you
                sit down to plan content. That is what this Creator Tool Hub is
                designed to provide.
              </p>

              <h3>How to use this hub in your weekly content workflow</h3>
              <p>
                A practical way to use these tools is to anchor them to your
                weekly content planning ritual. Instead of treating AI as a
                one-off experiment, you make it part of a repeatable system.
              </p>
              <ol>
                <li>Batch your video ideas for the upcoming week or month.</li>
                <li>
                  For each idea, start on the script prompt page and generate a
                  detailed prompt tailored to that topic.
                </li>
                <li>
                  Use your preferred AI model to draft the script, then refine
                  it into your voice.
                </li>
                <li>
                  Visit the hook generator to brainstorm multiple openings for
                ...
                <li>
                  Finish on the description generator to prepare search-friendly
                  copy and links.
                </li>
              </ol>
              <p>
                When this becomes a routine, you remove friction from planning
                and spend more time filming, editing, and improving your craft.
                AI becomes the scaffolding around your creativity, not a
                replacement for it.
              </p>
            </article>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Build scenario-based prompts for content, marketing, or learning in one place.
                      </p>
                    </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Create newsletter and launch email prompts that connect
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Generate detailed blog post outline prompts before you
                        write or draft with AI.
                      </p>
                    </div>
                    <span className="mt-2 inline-flex items-center text-[11px] font-medium text-indigo-600">
                      Open tool
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Create long-form SEO article prompts for blogs and content hubs.
                      </p>
                    </div>
                    <span className="mt-2 inline-flex items-center text-[11px] font-medium text-indigo-600">
                      Open tool
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Brief AI or designers to create click-worthy thumbnails
                        that match your titles.
                      </p>
                    </div>
                    <span className="mt-2 inline-flex items-center text-[11px] font-medium text-indigo-600">
                      Open tool
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Create hashtag sets for YouTube and other platforms
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-600">
                        Generate prompts tailored to faceless channels that rely
                        on B-roll and narration.
                      </p>
                    </div>
                    <span className="mt-2 inline-flex items-center text-[11px] font-medium text-indigo-600">
                      Open tool
