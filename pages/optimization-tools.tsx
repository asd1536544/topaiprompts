...
export default function OptimizationToolsPage() {
  return (
    <>
      <Head>
        <title>Optimization Tools for YouTube Creators | AI Tool Hub</title>
        <meta
          name="description"
          content="Explore optimization tools for YouTube: titles, thumbnails, tags, SEO analysis, and hashtags. Designed to improve click-through rate and search performance."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Optimization Tools for YouTube Creators | AI Tool Hub"
        />
        <meta
          property="og:description"
          content="Browse YouTube optimization tools for titles, thumbnails, tags, hashtags, and SEO analysis."
        />
      </Head>
